...
(function() {
  ...
  client.put('request/notification/byApps/', {
    ...
    if (err != null) {
      ...
      initialized = true;
      return module.exports.emptyQueue();
    }
  });
  ...
  module.exports.manage = function(notification, type, callback) {
    ...
    if (issues.length > 0) {
      issues = issues.join(" ");
      return callback("Notification malformed (problem with fields " + issues + ")");
    } else {
      if (notification.type === 'temporary') {
        return module.exports.processCreation(notification, callback);
      } else {
        return module.exports.createOrUpdate(notification, callback);
      }
    }
  };

  module.exports.createOrUpdate = function(notification, callback) {
    var params;
    if (!initialized) {
      return module.exports.queueOperation('createOrUpdate', notification, callback);
    } else {
      params = {
      ...
      return client.post('request/notification/byApps/', params, function(err, res, body) {
        ...
        if (err) {
          ...
          id = body[0].value._id;
          return module.exports.processUpdate(id, notification, callback);
        }
      });
    }
  };
  ...
  module.exports.destroy = function(notification, callback) {
    var params;
    if (!initialized) {
      return module.exports.queueOperation('destroy', notification, callback);
    } else {
      params = {
        key: [notification.app, notification.ref]
      };
      return client.post('request/notification/byApps/', params, function(err, res, body) {
        ...
        if (err) {
          ...
          id = body[0].value._id;
          return module.exports.processDestroy(id, callback);
        }
      });
    }
  };

  module.exports.queueOperation = function(action, notification, callback) {
    return queue.push({
      action: action,
  ...
  module.exports.emptyQueue = function() {
    ...
    for (_i = 0, _len = queue.length; _i < _len; _i++) {
      ...
      if (action.action === 'destroy') {
        ...
        _results.push(module.exports.createOrUpdate(action.notification, action.callback));
      } else {
  ...
  module.exports.processCreation = function(notification, callback) {
  ...
  module.exports.processUpdate = function(id, notification, callback) {
  ...
  module.exports.processDestroy = function(id, callback) {
  ...
  module.exports.normalize = function(notification) {
    var _ref1, _ref2;
  ...
  module.exports.validate = function(notification) {
