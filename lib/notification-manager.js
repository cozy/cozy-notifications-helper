...
(function() {
  var authentifiedEnvs, client, initialized, queue, ref, request,
  ...
  if (ref = process.env.NODE_ENV, indexOf.call(authentifiedEnvs, ref) >= 0) {
  ...
  module.exports._emptyQueue = function() {
    ...
    for (i = 0, len = queue.length; i < len; i++) {
      ...
      if (action.action === 'destroy') {
        results.push(module.exports.destroy(action.notification, action.callback));
      } else if (action.action === 'createOrUpdate') {
        results.push(module.exports._createOrUpdate(action.notification, action.callback));
      } else {
        results.push(void 0);
      }
    }
  ...
  module.exports._processDestroy = function(id, callback) {
    return client.del("data/" + id + "/", function(err, res, body) {
      var ref1, statusError;
      statusError = [404, 500];
      if (((res != null ? res.statusCode : void 0) != null) && (ref1 = res.statusCode, indexOf.call(statusError, ref1) >= 0)) {
        err = body;
      }
      return callback(err);
    });
  ...
  module.exports._normalize = function(notification) {
    ...
    if (notification.resource != null) {
      notification.resource = {
        app: ((ref1 = notification.resource) != null ? ref1.app : void 0) || null,
        url: ((ref2 = notification.resource) != null ? ref2.url : void 0) || '/'
      };
    } else {
      notification.resource = {
        app: null,
  ...
  module.exports._validate = function(notification) {
    ...
    if ((notification.type == null) || (ref1 = notification.type, indexOf.call(allowedTypes, ref1) < 0)) {
      issues.push('type');
    }
